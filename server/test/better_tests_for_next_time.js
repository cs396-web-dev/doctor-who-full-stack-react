...
const {
    ...
    expect404, expect404Delete, expect404Patch, fakeId
} = utils;
...
describe("/doctors/:id", () => {
    ...
    describe("GET", () => {
        ...
        it("Should return a 404 error for a non-existent (valid) id", done => {
            expect404('/doctors/{$fakeId}/goodparent', done);
        });
    });
    ...
    describe("PATCH", () => {
        ...
        it("Should return a 404 error for a non-existent id", done => {
            expect404Patch('/doctors/nonsense', done);
        });

        it("Should return a 404 error for a non-existent (valid) id", done => {
            expect404Patch('/doctors/{$fakeId}', done);
        });
    });
    ...
    describe("DELETE", () => {
        ...
        it("should return a 404 error for a non-existent id", done => {
            expect404Delete('/doctors/dummy', done);
        });

        it("Should return a 404 error for a non-existent (valid) id", done => {
            expect404Delete(`/doctors/${fakeId}`, done);
        });
    });
});
...
describe("/companions/:id", () => {
    ...
    describe("PATCH", () => {
        ...
        it("Should return a 404 error for a non-existent id", done => {
            expect404Patch('/companions/nonsense', done);
        });

        it("Should return a 404 error for a non-existent (valid) id", done => {
            expect404Patch('/companions/{$fakeId}', done);
        });
    });
    ...
    describe("DELETE", () => {
        ...
        it("should return a 404 error for a non-existent id", done => {
            expect404Delete('/companions/dummy', done);
        });

        it("Should return a 404 error for a non-existent (valid) id", done => {
            expect404Delete(`/companions/${fakeId}`, done);
        });
...
describe("/companions/:id/doctors", () => {
    ...
    describe("GET", () => {
        ...
        it("Should return a 404 error for a non-existent (valid) id", done => {
            expect404('/companions/{$fakeId}/doctors', done);
        });
    });
});
...
describe("/companions/:id/friends", () => {
    ...
    describe("GET", () => {
        ...
        it("Should return a 404 error for a non-existent (valid) id", done => {
            expect404('/companions/{$fakeId}/friends', done);
        });
